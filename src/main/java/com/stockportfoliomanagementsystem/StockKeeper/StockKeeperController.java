...
public class StockKeeperController implements Initializable {
    ...
    private void loadFromDB(){
        ...
        String goodsSold = "SELECT SUM(Total) AS Sold\n" +
                ...
                "WHERE EXTRACT(YEAR FROM Date_) = EXTRACT(YEAR FROM CURRENT_DATE)\n" +
                "AND EXTRACT(MONTH FROM Date_) = EXTRACT(MONTH FROM CURRENT_DATE)";
    ...
    public static void dbUpdate(){
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(stockTotal)) {
            pstmt.executeUpdate();
